...
$table1 = '<table border="0" width="650px">';
  $table1 .= '<tr>
                <td style="text-align: center; font-family: sans-serif; font-size: 16px; font-weight: bold">LAPORAN</td>
              </tr>';
$table1 .= '</table> </br>';
...
$table2 = '<table border="1" width="650px">';
  $table2 .= '<tr style="background-color: lightblue;">
                ...
                <td style="text-align: center; font-weight: bold; height: 30px; font-family: sans-serif; font-size: 14px;">Tanggal Peminjaman</td>
                <td style="text-align: center; font-weight: bold; height: 30px; font-family: sans-serif; font-size: 14px;">Batas Pengembalian</td>
                <td style="text-align: center; font-weight: bold; height: 30px; font-family: sans-serif; font-size: 14px;">Durasi</td>
              </tr>';

              foreach($laporan as $row){
                $table2 .= '<tr>
                <td style="text-align: center; font-family: sans-serif; font-size: 12px;">'. $row->id_pm .'</td>
                <td style="text-align: center; font-family: sans-serif; font-size: 12px;">'. $row->nama_apartment .'</td>
