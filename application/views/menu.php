<?php
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="<?= base_url('assets') ?>/dist/img/prfl.jpg" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="<?= base_url('apartment') ?>"><i class="fa fa-users"></i> Data Apartment</a></li>
 ...
 <li><a href="<?= base_url('') ?>"><i class="fa fa-users"></i> Profile</a></li>
